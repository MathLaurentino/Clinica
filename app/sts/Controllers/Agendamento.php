...
class Agendamento{
    ...
    public function horarios(): void
    {
        ...
        if (($_SESSION['tipo_usuario'] == "mantenedor")) {
            $_SESSION['msgRed'] = "Erro: mantenedor não pode realizar um agendamento!";
    ...
    public function agendar(): void
    {
        ...
        if (isset($_GET['dia']) && isset($_GET['horario']) && isset($_GET['servico'])) {
            ...
            $sitUser = $sts->verifySitUser($_SESSION['idusuario']);
