    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content text-center">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Horários de Atendimento</h5>
            ...
            <div class="modal-body" id="horario">
               ...
               <button type="button" class="" id="bnt12" value="12">12:00</button>

                <button type="button" class="" id="bnt13" value="13">13:00</button>

                <button type="button" class="" id="bnt14" value="14">14:00</button>

                <button type="button" class="" id="bnt15" value="15">15:00</button>

                <button type="button" class="" id="bnt16" value="16">16:00</button>

                <button type="button" class="" id="bnt17" value="17">17:00</button>

                <button type="button" class="" id="bnt18" value="18">18:00</button>
                ...
                <form method="post" action="">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10">
                            ...
                            <input type="submit" name="CadEvent" id="CadEvent" value="CadEvent" class="btn btn-success">   
